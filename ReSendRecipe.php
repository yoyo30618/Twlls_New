...
$edata1=true;
$ResposeArray = array();
$ResposeArray['Status']='SUCCESS';
if(isset($_GET['orderNo'])){
$ResposeArray['MerchantOrderNo']=$_GET['orderNo'];
    ...
    if($ResposeArray['Status']=='SUCCESS'){//藍新回覆刷卡成功，寄信給學會及買家收據
        ...
        if($SomeOneWantBuyResult->num_rows>0){//確認有這筆訂單
            ...
            while ($BuyInfoRow = mysqli_fetch_array($SomeOneWantBuyResult)) {
                ...
                $chineseSum = num2str($CheckBuySQL['Amt']);
...
?>
<script>
    setTimeout(() => confirm("補發收據完成") && (window.location.href = "DataQuery.php"), 5000);
</script>
