					...
					<div class="news-grid-rght3">
						<div class="story"> 
							<table style="width:100%;" class="table table-bordered"> <!--論文獎結果-->
								...
								<tr>
									<td rowspan="2" style="text-align:center;">第一屆<br>(2013)</td>
									<td style="text-align:center;">鄭齊兒</td>
									<td style="text-align:center;">Mechanism of extreme phonetic reduction: Evidence from Taiwan Mandarin</td>
								</tr>
								<tr>
									<td style="text-align:center;">潘家榮</td>
									<td style="text-align:center;">A Grammar of Lha'alua, an Austronesian Language of Taiwan</td>
								</tr>
							</table>
						</div>
					</div><br>
